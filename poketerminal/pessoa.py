...
NOMES = ['João','Bruno','Douflas','Guilherme','Mauricio','Eliseu','Pedro']
POKEMONS = [
...
class Pessoa:
    ...
    def escolher_pokemon(self):
        if self.pokemons:
            ...
            print('ERRO: Esse pokemon não possui nenhum pokemon para ser escolhido')
        ...
        if random.random() <= 0.3:
            ...
            if escolha == 'S':
                    if random.random() >= 0.5:
                        ...
                        print('{} fugiu! Se fode ai kkkkkk'.format(pokemon))
            else:
                print('Ok, boa viagem')
        else:
